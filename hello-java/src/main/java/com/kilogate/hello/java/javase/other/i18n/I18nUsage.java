...
public class I18nUsage {
    public static void main(String[] args) {
        ...
        ResourceBundle resourceBundle1 = ResourceBundle.getBundle("myi18n", locale1);
        System.out.println(resourceBundle1.getString("hi"));

        Locale locale2 = Locale.getDefault();
        ResourceBundle resourceBundle2 = ResourceBundle.getBundle("myi18n", locale2);
        System.out.println(resourceBundle2.getString("hi"));

        Locale locale3 = new Locale("en", "US");
        ResourceBundle resourceBundl3 = ResourceBundle.getBundle("myi18n", locale3);
